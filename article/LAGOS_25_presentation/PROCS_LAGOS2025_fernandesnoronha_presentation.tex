...
\begin{frame}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[scale=0.8]
            ...
            % Row 1: A B
            \node[circle, draw, fill=blue!20, minimum size=0.6cm] (A) at (0, 4) {};
            \node[circle, draw, fill=blue!20, minimum size=0.6cm] (B) at (4, 4) {};
            
            % Row 2: C D E  
            \node[circle, draw, fill=blue!20, minimum size=0.6cm] (C) at (-2, 2) {};
            \node[circle, draw, fill=blue!20, minimum size=0.6cm] (D) at (2, 2) {};
            \node[circle, draw, fill=blue!20, minimum size=0.6cm] (E) at (6, 2) {};
            
            % Row 3: F G H
            \node[circle, draw, fill=blue!20, minimum size=0.6cm] (F) at (0, 0) {};
            \node[circle, draw, fill=blue!20, minimum size=0.6cm] (G) at (2, 0) {};
            \node[circle, draw, fill=blue!20, minimum size=0.6cm] (H) at (4, 0) {};
...
%-------------------------------------------------
% SLIDE 3: Minimum Spanning Tree and Forest
%-------------------------------------------------
\begin{frame}
...
%-------------------------------------------------
% SLIDE 4: Incremental MSF Problem
%-------------------------------------------------
\begin{frame}
...
%-------------------------------------------------
% SLIDE 5: Incremental MSF Example - Step 1
%-------------------------------------------------
\begin{frame}
...
%-------------------------------------------------
% SLIDE 6: Incremental MSF Example - Step 2
%-------------------------------------------------
\begin{frame}
...
%-------------------------------------------------
% SLIDE 7: Incremental MSF Example - Step 3
%-------------------------------------------------
\begin{frame}
...
%-------------------------------------------------
% SLIDE 8: Incremental MSF Example - Step 4
%-------------------------------------------------
\begin{frame}
...
%-------------------------------------------------
% SLIDE 9: Incremental MSF Example - Step 5
%-------------------------------------------------
\begin{frame}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[scale=0.8]
            ...
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (F) -- (G) node[midway, below=0.1cm, font=\small] {6};
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (A) -- (F) node[midway, left=0.1cm, font=\small] {2};
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (C) -- (F) node[midway, left=0.1cm, font=\small] {5};
    ...
    \begin{itemize}
    \item \textbf{MSF:} \{G-H, C-A, F-G, A-F, C-F\} \vfill
    \end{itemize}
    \note{
...
%-------------------------------------------------
% SLIDE 10: Incremental MSF Example - Step 6
%-------------------------------------------------
\begin{frame}
    ...
    \begin{itemize}
    \item \textbf{MSF:} \{G-H, C-A, F-G, A-F, C-F, F-D\} \vfill
    \end{itemize}
    \note{
...
%-------------------------------------------------
% SLIDE 11: Incremental MSF Example - Step 7
%-------------------------------------------------
\begin{frame}
    \frametitle{Incremental MSF example - Step 7}
    
    \begin{itemize}
    \item \textbf{add\_edge(A, B, 8):} Add edge with cost 8 \vfill
    \end{itemize}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[scale=0.8]
            ...
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (C) -- (F) node[midway, left=0.1cm, font=\small] {5};
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (F) -- (D) node[midway, left=0.1cm, font=\small] {7};
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (A) -- (B) node[midway, above=0.1cm, font=\small] {8};
            
            % Labels
            \node[blue, font=\Large] at (-3, 2) {G};
            \node[red, font=\Large] at (7, 2) {MSF};
        \end{tikzpicture}
        \caption{Step 7: Added edge (A,B) with cost 8}
    \end{figure}
    
    \begin{itemize}
    \item \textbf{MSF:} \{G-H, C-A, F-G, A-F, C-F, F-D, A-B\} \vfill
    \end{itemize}
    \note{
...
%-------------------------------------------------
% SLIDE 12: Incremental MSF Example - Step 8
%-------------------------------------------------
\begin{frame}
    \frametitle{Incremental MSF example - Step 8}
    
    \begin{itemize}
    \item \textbf{add\_edge(G, D, 2):} Add edge with cost 2 \vfill
    \item \textbf{Cycle detected!} Replace expensive edge \vfill
    \end{itemize}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[scale=0.8]
            ...
            % MSF edges (red wavy lines)
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (C) -- (A) node[midway, left=0.1cm, font=\small] {1};
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (A) -- (F) node[midway, left=0.1cm, font=\small] {2};
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (F) -- (D) node[midway, left=0.1cm, font=\small] {1};
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (G) -- (D) node[midway, right=0.1cm, font=\small] {2};
            
            % Edges NOT in MSF (blue straight lines)
            \draw[blue, thick] (A) -- (D) node[midway, above=0.1cm, font=\small] {3};
            \draw[blue, thick] (F) -- (G) node[midway, below=0.1cm, font=\small] {6};
            
            % Labels
            \node[blue, font=\Large] at (-3, 2) {G};
            \node[red, font=\Large] at (7, 2) {MSF};
        \end{tikzpicture}
        \caption{Step 8: Added edge (G,D) with cost 2 - replaced edge (F,G)}
    \end{figure}
    
    \begin{itemize}
    \item \textbf{MSF:} \{C-A, A-F, F-D, G-D\} (cost improved) \vfill
    \end{itemize}
    \note{
        - Show edge replacement in action
        - Explain how MSF cost improves
    }
\end{frame}

%-------------------------------------------------
% SLIDE 13: Incremental MSF Example - Step 9
%-------------------------------------------------
\begin{frame}
    \frametitle{Incremental MSF example - Step 9}
    
    \begin{itemize}
    \item \textbf{add\_edge(B, D, 3):} Add edge with cost 3 \vfill
    \end{itemize}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[scale=0.8]
            ...
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (F) -- (D) node[midway, left=0.1cm, font=\small] {1};
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (G) -- (D) node[midway, right=0.1cm, font=\small] {2};
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (B) -- (D) node[midway, above=0.1cm, font=\small] {3};
            ...
            \node[red, font=\Large] at (7, 2) {MSF};
        \end{tikzpicture}
        \caption{Step 9: Added edge (B,D) with cost 3}
    \end{figure}
    
    \begin{itemize}
    \item \textbf{MSF:} \{C-A, A-F, F-D, G-D, B-D\} \vfill
    \end{itemize}
    \note{
        - Show ninth edge being added
        - No cycle, so added to MSF
    }
\end{frame}

%-------------------------------------------------
% SLIDE 14: Incremental MSF Example - Step 10
%-------------------------------------------------
\begin{frame}
    \frametitle{Incremental MSF example - Step 10}
    
    \begin{itemize}
    \item \textbf{add\_edge(B, E, 1):} Add edge with cost 1 \vfill
    \end{itemize}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[scale=0.8]
            ...
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (G) -- (D) node[midway, right=0.1cm, font=\small] {2};
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (B) -- (D) node[midway, above=0.1cm, font=\small] {3};
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (B) -- (E) node[midway, right=0.1cm, font=\small] {1};
            ...
            \node[red, font=\Large] at (7, 2) {MSF};
        \end{tikzpicture}
        \caption{Step 10: Added edge (B,E) with cost 1}
    \end{figure}
    
    \begin{itemize}
    \item \textbf{MSF:} \{C-A, A-F, F-D, G-D, B-D, B-E\} \vfill
    \end{itemize}
    \note{
        - Show tenth edge being added
        - No cycle, so added to MSF
    }
\end{frame}

%-------------------------------------------------
% SLIDE 15: Incremental MSF Example - Step 11
%-------------------------------------------------
\begin{frame}
    \frametitle{Incremental MSF example - Step 11}
    
    \begin{itemize}
    \item \textbf{add\_edge(H, E, 2):} Add edge with cost 2 \vfill
    \end{itemize}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[scale=0.8]
            ...
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (B) -- (D) node[midway, above=0.1cm, font=\small] {3};
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (B) -- (E) node[midway, right=0.1cm, font=\small] {1};
            \draw[red, thick, decorate, decoration={snake, amplitude=1pt, segment length=8pt}] (H) -- (E) node[midway, right=0.1cm, font=\small] {2};
            ...
            \node[red, font=\Large] at (7, 2) {MSF};
        \end{tikzpicture}
        \caption{Step 11: Added edge (H,E) with cost 2}
    \end{figure}
    
    \begin{itemize}
    \item \textbf{MSF:} \{C-A, A-F, F-D, G-D, B-D, B-E, H-E\} \vfill
    \end{itemize}
    \note{
        - Show eleventh edge being added
        - No cycle, so added to MSF
    }
\end{frame}

%-------------------------------------------------
% SLIDE 16: Incremental MSF Example - Final Result
%-------------------------------------------------
\begin{frame}
...
%-------------------------------------------------
% SLIDE 18: Frederickson's Link-Cut Tree Solution
%-------------------------------------------------
\begin{frame}
...
%-------------------------------------------------
% SLIDE 19: What is Retroactivity?
%-------------------------------------------------
\begin{frame}
...
%-------------------------------------------------
% SLIDE 20: Partial vs Full Retroactivity
%-------------------------------------------------
\begin{frame}
...
%-------------------------------------------------
% SLIDE 22: Demaine, Iacono & Langerman's Solution
%-------------------------------------------------
\begin{frame}
...
%-------------------------------------------------
% SLIDE 25: Limitations of Junior & Seabra
%-------------------------------------------------
\begin{frame}
...
%-------------------------------------------------
% SLIDE 26: Our Solution - Rebuilding Strategy
%-------------------------------------------------
\begin{frame}
...
%-------------------------------------------------
% SLIDE 29: Extending for Full Retroactivity
%-------------------------------------------------
\begin{frame}
