...
Com isso, como esta rotina usa apenas os métodos fornecidos pelas \emph{link-cut trees}, podemos concluir que ela consome tempo amortizado $\Oh(\log n)$, onde $n$ é o número de vértices do grafo representado.
