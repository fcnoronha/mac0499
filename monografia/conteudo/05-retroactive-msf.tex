...
Vale notar que tanto a solução de Andrade Júnior e Duarte Seabra quanto a versão aqui apresentada não implementam completamente retroatividade, pois ambas não dão suporte a remoção de operações. Por isso decidimos nos referir a estas duas soluções como \emph{semi-retroativas}.
