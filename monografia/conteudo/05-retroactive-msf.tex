...
% %% ------------------------------------------------------------------------- %%
% \subsection{reconstrução da decomposição}
% \label{sec:rmsf-reconstru}
