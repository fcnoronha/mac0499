...
\begin{frame}[fragile]\centering
  ...
  \begin{columns}[T]
    ...
    \begin{block}{Link-Cut tree}
      ...
      \begin{shaded}
        \textbf{Ideia:} Dividir a floresta em caminhos vértice-disjuntos, chamados \textbf{caminhos preferidos}. Cada um desses caminhos é representado na forma de uma \textit{splay tree}, uma estrutura que nos permite unir e quebrar estes caminhos de forma bastante eficiente.
      \end{shaded}
    ...
    \begin{exampleblock}
      ...
      As link-cut trees fornece a seguinte interface:
    ...
    \begin{block}{Floresta geradora mínima retroativa}
      ...
      \begin{figure}
        ...
        \end{equation*}
        \caption{Representação da lista de arestas inseridas com $m$ igual a $8$. Neste caso, cada bloco tem tamanho $2$. Assim, por exemplo, a estrutura $F_3$ contém todas as arestas adicionadas desde o instante $1$ até o instante $6$.}
